                ...
                <div class="p-4 block w-full overflow-x-auto">
                    <div class="p-6 mb-6 border rounded-lg bg-gray-50">
                        ...
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <div class="w-1/4">
                                @if($cv->picture)
                                    <img src="{{ Storage::url($cv->picture) }}" alt="Profile Picture" class="w-full h-auto rounded-lg shadow-md">
                                @else
                                    <img src="{{ Storage::url('pictures/default-avatar.png') }}" alt="Default Avatar" class="w-full h-auto rounded-lg shadow-md">
                                @endif
                            </div>
                            <!-- Main Description -->
                            <div class="ml-6">
                                ...
                                <div class="border rounded-lg bg-white p-4">
                                    @foreach($cv->educations as $education)
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <p class="text-sm text-gray-600">{{ $education->education_level }}</p>
                                            <h3 class="font-semibold mb-2">Institution</h3>
                                            <p class="text-sm text-gray-600">{{ $education->education_institution }}</p>
                                ...
                                <div class="border rounded-lg bg-white p-4">
                                    @foreach($cv->experiences as $experience)
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <p class="text-sm text-gray-600">{{ $experience->experience_position }}</p>
                                            <h3 class="font-semibold mb-2">Company</h3>
                                            <p class="text-sm text-gray-600">{{ $experience->experience_company }}</p>
                                            <h3 class="font-semibold mb-2">Business Type</h3>
                                            <p class="text-sm text-gray-600">{{ $experience->experience_business_type }}</p>
                                ...
                                <div class="border rounded-lg bg-white p-4">
                                    ...
                                    @foreach($cv->licenses as $license)
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <p class="text-sm text-gray-600">{{ $license->license_name }}</p>
                                            <h3 class="font-semibold mb-2">Issuer</h3>
                                            <p class="text-sm text-gray-600">{{ $license->license_institution }}</p>
                                            <h3 class="font-semibold mb-2">ID</h3>
                                            <p class="text-sm text-gray-600">{{ $license->license_id }}</p>
